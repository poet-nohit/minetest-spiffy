...
local get_ambience = function(player)
	...
	local tempy = minetest.find_nodes_in_area({x=pos.x-6,y=pos.y-3, z=pos.z-6},{x=pos.x+6,y=pos.y+3, z=pos.z+6},
	...
	for _, npos in ipairs(tempy) do
		...
		if num_lava > 5 or num_water_flowing > 45 or num_water_source > 100 or num_desert > 150 then break end
	end
	-- END messy
