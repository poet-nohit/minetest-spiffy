...
local oredefs = {
	...
	mithril = {
		...
		tools = {
			pick = {
				cracky = {times = {[1] = 0, [2] = 0, [3] = 0}, uses = 200, maxlevel = 3}
			},
			hoe = {
				uses = 1000
			},
			shovel = {
				crumbly = {times = {[1] = 0, [2] = 0, [3] = 0}, uses = 200, maxlevel = 3}
			},
			axe = {
				choppy = {times = {[1] = 0, [2] = 0, [3] = 0}, uses = 200, maxlevel = 2},
				fleshy = {times = {[2] = 0.95, [3] = 0.30}, uses = 200, maxlevel = 2}
			},
			sword = {
				fleshy = {times = {[2] = 0, [3] = 0}, uses = 200, maxlevel = 3},
				snappy = {times = {[2] = 0.70, [3] = 0.25}, uses = 200, maxlevel = 3},
				choppy = {times = {[3] = 0.65}, uses = 200, maxlevel = 2}
			}
		},
