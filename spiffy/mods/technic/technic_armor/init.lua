local modpath = minetest.get_modpath("technic_armor")

-- reference:
-- armor: wood=1.04, iron/bronze/gold=2.08, diamond=2.92
-- heal: bronze/gold=6, diamond/mithril=12
-- use: wood=2000, cactus=1000, iron=500, bronze/gold=250, diamond=100, mithril=50

local stats = {
	tin = { name="Tin", armor=1.6, heal=0, use=750 },
	silver = { name="Silver", armor=1.8, heal=6, use=650 },
